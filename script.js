...
var munheco = document.querySelector(".munhequito");
var contenedor = document.querySelector(".paracontainer");
...
function recuperarTexto(){
    var cajatexto = document.querySelector(".catex");
...
const butCopy = document.querySelector(".butcopy");
    butCopy.addEventListener("click", copiar = () => {
